    ...
    <div class="flex">
        ...
        <div class="w-[60%]">
            <div class="flex justify-end items-center relative">
                <img class="rounded-10" src="{{Vite::asset('resources/images/about-us/img-1.jpg')}}" alt="About Us 1">
                <img class="rounded-10 ml-5" src="{{Vite::asset('resources/images/about-us/img-2.jpg')}}" alt="About Us 2">
