            ...
            <div class="container flex justify-between">
                ...
                <div class="flex flex-row items-center">
                    <div class="flex flex-row gap-5">
                        <input class="rounded-5 text-gray-body text-sm px-4" type="text" placeholder="Name*">
                        <input class="rounded-5 text-gray-body text-sm px-4" type="text" placeholder="Phone*">
                        <x-button>Submit Now</x-button>
                    </div>
                </div>
            </div>
