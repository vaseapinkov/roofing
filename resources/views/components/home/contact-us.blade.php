<section>
    <div class="" style="background-image:url({{Vite::asset('resources/images/newsletter_bg.jpg')}});">
        <div class="bg-primary-500/80 h-full w-full py-[90px]">
            ...
            <div class="container flex flex-col 2xl:flex-row text-center 2xl:text-start justify-between">
                ...
                <div class="flex flex-row items-center mx-auto 2xl:mx-0">
                    <div class="flex flex-col 2xl:flex-row gap-5">
                        <input class="border border-gray-light-alt rounded-5 text-gray-body text-sm px-4 py-4" type="text" placeholder="Name*">
                        <input class="border border-gray-light-alt rounded-5 text-gray-body text-sm px-4 py-4" type="text" placeholder="Phone*">
                        <x-button type="primary" class="w-fit mx-auto 2xl:mx-0">Submit Now</x-button>
                    </div>
                </div>
            </div>
