<section id="hero" class="relative ps-[20px] 2xl:ps-[240px] font-heading">
    ...
    <div class="bg-primary-500 w-[44%] 2xl:w-[22%] h-[calc(100vh-104px)] absolute top-0 left-0"></div>

    <div class="relative z-10 rounded-bl-xl min-h-[440px] 2xl:min-h-[700px] flex items-center before:absolute before:w-full before:h-full before:bg-gradient-to-r before:from-black/50 before:via-transparent before:to-transparent before:rounded-bl-xl"
