                    ...
                    <div class="swiper-wrapper">
                        @foreach(range(1, 6) as $index)
                            <div class="swiper-slide pr-8">
                                ...
                                <p class="italic text-gray-body text-lg mb-5 pointer-events-none">There are many varation of paissages of Lorem as the Ipum available but our majority have sufferied alterations in some form, by our by injected hsumour randomised worids which don't looks even slightly there as believable. If you going to use a passage of Lorem Ipsum.</p>

                                <div class="flex gap-4 items-center pointer-events-none">
                                    <img class="rounded-full h-[80px] aspect-square" src="{{Vite::asset('resources/images/testi_avatar01.png')}}" alt="Customer Avatar">

                                    <div class="font-heading">
                                        <h5 class="text-gray-title text-xl font-bold">Darrell Steward</h5>
                                        <span class="text-primary-500 text-sm">Roofing Expert</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
