    ...
    <div class="rounded-10 p-[20px] sm:p-[35px] xl:p-[65px] grid grid-cols-12" style="background-image:url({{Vite::asset('resources/images/appointment_bg.jpg')}});">
        <form class="col-span-12 lg:col-span-7" wire:submit.prevent="saveMessage">
            <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                <input wire:model="firs_name" class="border border-gray-light-alt rounded-5 text-gray-body text-sm px-4 py-4 col-span-2 sm:col-span-1" type="text" name="first-name" placeholder="First Name*">
                ...
                <input wire:model="state" class="border border-gray-light-alt rounded-5 text-gray-body text-sm px-4 py-4 col-span-2 sm:col-span-1" type="text" name="state" placeholder="State*">
                <input wire:model="city" class="border border-gray-light-alt rounded-5 text-gray-body text-sm px-4 py-4 col-span-2 sm:col-span-1" type="text" name="city" placeholder="City*">
        ...
        <div class="hidden lg:block col-span-5 relative">
            <div class="absolute -bottom-[35px] -right-[35px] xl:-bottom-[65px] xl:-right-[65px] w-full">
