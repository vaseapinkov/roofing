...
<section @class(['pb-[90px]' => $overlap, 'py-[90px]' => !$overlap, 'bg-center bg-no-repeat bg-cover' => 'hasBackgroundImage']) @if($hasBackgroundImage) style="background-image: url('{{asset('storage/' . $backgroundImage)}}')" @endif>
    <div class="container">
