...
<section id="about-us" class="container mx-auto pt-[90px] pb-[90px]">

    <x-section-title :centred="true" :title="$heading" :sub-title="$subHeading"/>

    <div class="flex flex-col md:flex-row md:justify-center flex-wrap xl:flex-nowrap gap-8 pt-6">

        @foreach($items as $item)
            <div class="flex flex-row gap-5 md:w-[45%] xl:w-full">
                <div class="relative">
